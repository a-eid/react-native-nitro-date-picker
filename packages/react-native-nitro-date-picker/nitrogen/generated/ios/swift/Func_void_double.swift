...
/**
 * Wraps a Swift `(_ timestamp: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.nitrodatepicker.bridge.swift

  private let closure: (_ timestamp: Double) -> Void

  public init(_ closure: @escaping (_ timestamp: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(timestamp: Double) -> Void {
    self.closure(timestamp)
  }
