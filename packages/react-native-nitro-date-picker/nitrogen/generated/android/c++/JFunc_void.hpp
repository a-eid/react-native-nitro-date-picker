...
namespace margelo::nitro::nitrodatepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrodatepicker/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrodatepicker/Func_void_cxx;";
