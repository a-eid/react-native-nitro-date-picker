...
/**
 * Represents the JavaScript callback `(timestamp: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(timestamp: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  @Keep
  override fun invoke(timestamp: Double): Unit
    = invoke_cxx(timestamp)

  @FastNative
  private external fun invoke_cxx(timestamp: Double): Unit
}
...
class Func_void_double_java(private val function: (Double) -> Unit): Func_void_double {
  ...
  @Keep
  override fun invoke(timestamp: Double): Unit {
    return this.function(timestamp)
  }
}
